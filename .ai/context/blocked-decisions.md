...
- Add fake-client contracts before runtime sync code or a production sync toggle
- Keep encrypted backup/restore UX as staged follow-up work
- Keep offline dictionary packs out of sync MVP scope

Acceptance gate:
- Runtime cloud sync code may start after fake Supabase client tests and auth manual smoke gates exist.
