...
- No automatic foreground/background/realtime sync in v1.3.0; users must explicitly enable beta sync and tap "Đồng bộ ngay".
...
## In Progress
- v1.3.0 product-readiness verification, Supabase redirect allow-list smoke, and provider env smoke.
