...
- No automatic foreground/background/realtime sync in v1.2.2; users must explicitly enable beta sync and tap "Đồng bộ ngay".
...
## In Progress
- v1.2.2 release consistency verification, Supabase redirect allow-list smoke, and provider env smoke.
